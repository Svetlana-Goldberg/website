...
$(document).on('click', '.main--drop-down-top', function (e) {
    e.stopPropagation();

    const currentDropDown = $(this).parent('.main--drop-down');
    const currentInfo = currentDropDown.children('.main--drop-down-info');

    if (currentDropDown.hasClass('active')) {
        currentInfo.slideUp();
        currentDropDown.removeClass('active');
    } else {
        currentInfo.slideDown();
